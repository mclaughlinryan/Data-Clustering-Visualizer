...
This application allows the user to visualize the clustering of data through selection from several different clustering algorithms as well as side-by-side comparison of different data clusterings.
...
The algorithm's cluster assignments along with the feature data can be saved as a text or CSV file and the clustering display can also be saved.
